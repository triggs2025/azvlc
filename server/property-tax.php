...
function lookupCountyParcel($county, $lon, $lat, $matchedAddress = '') {
    $counties = [
        ...
        'Pima County' => [
            'endpoint'    => 'https://gisdata.pima.gov/arcgis1/rest/services/GISOpenData/LandRecords/MapServer/0',
            'field'       => 'PARCEL',
            'clean'       => 'none',
            'parcelUrl'   => null,
            'assessorUrl' => 'https://www.asr.pima.gov/',
        ],
        'Pinal County' => [
            'endpoint'    => 'https://gis.pinal.gov/mapping/rest/services/TaxParcels/FeatureServer/3',
            'field'       => 'PARCELID',
            'clean'       => 'none',
            'parcelUrl'   => null,
            'assessorUrl' => 'https://www.pinalcountyaz.gov/630/Assessor',
        ],
        'Yavapai County' => [
            'endpoint'    => 'https://gis.yavapaiaz.gov/arcgis/rest/services/Parcels/MapServer/0',
            'field'       => 'PARCEL_ID',
            'clean'       => 'none',
            'parcelUrl'   => null,
            'assessorUrl' => 'https://www.yavapaiaz.gov/Assessor',
        ],
        'Cochise County' => [
        ...
        'Santa Cruz County' => [
            ...
            'assessorUrl' => 'https://www.santacruzcountyaz.gov/180/Assessor',
        ],
        'Gila County' => [
